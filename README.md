...
| Field | Description |
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Article ID | Identifier for the SR function. Links metadata to the associated dataset |
...
| Species Latin Name | Genus species name (e.g., _Oncorhynchus kisutch_, _Oncorhynchus tshawytscha_) |
